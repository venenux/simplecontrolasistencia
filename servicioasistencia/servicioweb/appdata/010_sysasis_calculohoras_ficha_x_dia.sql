...
-- /**
--  * @nombre  siscat_sp_100100_cods_ondemand
--  * @author  lucero_fenix Tyrone Lucero <tyrone.lucero@gmail.com>
--  * @description FUNCION CALCULA HORAS EN UN DIA TODOS LOS LUGARES TRABAJADOS POR UN TRABAJADOR
--  * @depends : tabla sysasis_registro
