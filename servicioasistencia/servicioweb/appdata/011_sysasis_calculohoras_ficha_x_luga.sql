...
--  * @description FUNCION CALCULA HORAS TRABAJADAS POR UN TRABAJADOR POR UN LUGAR EN UN DIA
...
--  * @param lugar : codigo "codger" del lugar o gerenci a l cual se le desea ver horas laboradas
--  */
...
BEGIN
	...
	-- fich po ahora es 8 caracteres/digitos, hacer autocompletado:
